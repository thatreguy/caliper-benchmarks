...
./network.sh deployCC -ccn fabcar -ccp /home/vivek/caliper-benchmarks/src/fabric/samples/fabcar/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
...
if [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
  ...
  ./network.sh deployCC -ccn marbles -ccp /home/vivek/caliper-benchmarks/src/fabric/samples/marbles/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
fi
...
if [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
  ...
  ./network.sh deployCC -ccn marbles-norichquery -ccp /home/vivek/caliper-benchmarks/src/fabric/samples/marbles-norichquery/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
fi
...
if [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
  ...
  ./network.sh deployCC -ccn simple -ccp /home/vivek/caliper-benchmarks/src/fabric/scenario/simple/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
fi
...
#   ./network.sh deployCC -ccn smallbank -ccp /home/vivek/caliper-benchmarks/src/fabric/scenario/smallbank/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
# fi
...
./network.sh deployCC -ccn fixed-asset -ccp /home/vivek/caliper-benchmarks/src/fabric/api/fixed-asset/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
...
if [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
  ...
  ./network.sh deployCC -ccn fixed-asset-base -ccp /home/vivek/caliper-benchmarks/src/fabric/api/fixed-asset-base/$CC_SRC_PATH -ccl $CC_SRC_LANGUAGE
fi
